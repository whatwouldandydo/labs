    ...
    try:
        ...
        if user_input == 1:
            ...
            try:
                ...
                print()
                print(f'"{cal_win}" Bytes is the Window Size for the network speed of "{net_speed} Mbits/sec" with "{net_delay}" milliseconds latency.\n')
                print("-" * 100)
                ...
                print("\nPlease enter a whole number with no comma or period.\n")
        elif user_input == 2:
            """
            ...
            try:
                ...
                try:
                    ...
                    print(f"\nThe network latency cannot be 0. Please try again...\n")
            except ValueError:
                print("\nPlease enter a whole number with no comma or period.\n")
        else:
            print("Exist Program ...\n")
